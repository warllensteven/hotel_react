      ...
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            ...
            <a href="#cont-servicios" className="text-sm font-semibold text-gray-900">
              Servicios
            </a>
            <a href="/reservas" className="text-sm font-semibold text-gray-900">
              Reservas
            </a>
            <a href="/informacion" className="text-sm font-semibold text-gray-900">
              Sobre nosotros
            </a>
          </div>
